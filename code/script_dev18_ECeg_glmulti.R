#GLmulti Learning, created by Brian Craig in Oct. 2022
# Script developed for use with dataframes containing indicies to develop a
# multiple linear regression model to predict EC. The model is then evaluated
# and cross-validated via "leave one field out" root mean squared prediciton
# Error

#For glmulti, we're looking at 2018 Dev ECe NOTinterpolated
